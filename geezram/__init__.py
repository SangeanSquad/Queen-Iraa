...
def get_user_list(__init__, key):
    with open("{}/geezram/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[geezram] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[geezram]')
LOGGER.info("Queen Iraa is starting. | Powered By Geez|RAM. | Licensed under GPLv3.")
LOGGER.info("Not a part of any other pack of shit.")
LOGGER.info("Project maintained by: github.com/SangeanSquad (t.me/kang_keong17)")
...
from geezram.modules.helper_funcs.handlers import (
