...
import sys
import traceback
import geezram.modules.sql.users_sql as sql
...
from geezram.modules import ALL_MODULES
from geezram.modules.helper_funcs.chat_status import is_user_admin
from geezram.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="tentang saya", callback_data="geezram_"),
        InlineKeyboardButton(
            text="repo", callback_data="source_"),
    ],
    [
        InlineKeyboardButton(
...
def geezram_about_callback(update, context):
    ...
    if query.data == "geezram_":
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    ...
                    InlineKeyboardButton(text="RAM Support", url="https://t.me/ramsupportt"),
                 ],
                 [
        ...
        query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Go Back", callback_data="geezram_")]]
            ),
        )

    elif query.data == "geezram_notes":
        query.message.edit_text(
    ...
    elif query.data == "geezram_support":
        query.message.edit_text(
            text="*Geez|RAM support chats*"
            f"\nI dont have any official support group, but you can report or query on Geez or Ram support, for the error on {dispatcher.bot.first_name}.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
    ...
    elif query.data == "geezram_credit":
        query.message.edit_text(
            text=f"Credis for {dispatcher.bot.first_name}\n"
            f"\nFuck the credit of {dispatcher.bot.first_name}",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        geezram_about_callback, pattern=r"geezram_", run_async=True
    )
    ...
    if WEBHOOK:
        ...
        LOGGER.info("Geez|RAM is online, long pooling started.")
