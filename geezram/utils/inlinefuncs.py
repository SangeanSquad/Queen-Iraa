...
from geezram import arq
from geezram.services.keyboard import Ikb
from geezram.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from geezram.services.tasks import _get_tasks_text, all_tasks, rm_task
from geezram.services.types import InlineQueryResultCachedDocument
from geezram.modules.info import get_chat_info, get_user_info
from geezram.modules.music import download_youtube_audio
from geezram.utils.functions import test_speedtest
from geezram.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/3b757c3986ec72f09096c.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/geezrambot"),
        InlineKeyboardButton(
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/kang_keong17)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    ...
    group_invite = "https://t.me/joinchat/ramsupportt"
    try:
        messages = [
            m
