...
import geezram.modules.sql.global_bans_sql as gban_sql
import geezram.modules.sql.users_sql as user_sql
from geezram import DEV_USERS, OWNER_ID, dispatcher
from geezram.modules.helper_funcs.chat_status import dev_plus
