...
import geezram.modules.sql.welcome_sql as sql
from geezram import (
    DEV_USERS,
    OWNER_ID,
    DRAGONS,
...
from geezram.modules.helper_funcs.misc import build_keyboard, revert_buttons
from geezram.modules.helper_funcs.msg_types import get_welcome_type
...
from geezram.modules.sql.global_bans_sql import is_user_gbanned
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    f"Welcome to {html.escape(chat.title)} my booss.", reply_to_message_id=reply
                )
                welcome_log = (
