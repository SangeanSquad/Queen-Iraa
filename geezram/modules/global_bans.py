...
import geezram.modules.sql.global_bans_sql as sql
from geezram.modules.sql.users_sql import get_user_com_chats
from geezram import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from geezram.modules.helper_funcs.misc import send_to_list
